...
/**
   Inserts all permutations of a std::string into a red-black tree and checks that 
   it contains the std::strings afterward.
   @param letters a sorted std::string of letters without repetition
